...
var require_md5 = __commonJS({
  "../node_modules/ts-md5/dist/cjs/md5.js"(exports2) {
    "use strict";
...
var require_md5_file_hasher = __commonJS({
  "../node_modules/ts-md5/dist/cjs/md5_file_hasher.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.Md5FileHasher = void 0;
    ...
    exports2.Md5FileHasher = Md5FileHasher;
  }
});

// ../node_modules/ts-md5/dist/cjs/parallel_hasher.js
var require_parallel_hasher = __commonJS({
  "../node_modules/ts-md5/dist/cjs/parallel_hasher.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.ParallelHasher = void 0;
    var ParallelHasher = (
      /** @class */
      function() {
    ...
    exports2.ParallelHasher = ParallelHasher;
  }
});

// ../node_modules/ts-md5/dist/cjs/index.js
var require_cjs = __commonJS({
  "../node_modules/ts-md5/dist/cjs/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.ParallelHasher = exports2.Md5FileHasher = exports2.Md5 = void 0;
    var md5_1 = require_md5();
    Object.defineProperty(exports2, "Md5", { enumerable: true, get: function() {
      return md5_1.Md5;
    } });
    var md5_file_hasher_1 = require_md5_file_hasher();
    Object.defineProperty(exports2, "Md5FileHasher", { enumerable: true, get: function() {
      return md5_file_hasher_1.Md5FileHasher;
    } });
    var parallel_hasher_1 = require_parallel_hasher();
    Object.defineProperty(exports2, "ParallelHasher", { enumerable: true, get: function() {
...
// src/index.node.ts
var index_node_exports4 = {};
__export(index_node_exports4, {
  AACDepay: () => AACDepay,
  Auth: () => Auth,
  ...
  timestamp: () => timestamp,
  utils: () => index_node_exports3,
  version: () => version
});
module.exports = __toCommonJS(index_node_exports4);
...
var H264Depay = class extends Tube {
  constructor() {
    ...
    const incoming = new import_stream4.Transform({
      objectMode: true,
      transform(msg, _encoding, callback) {
        if (msg.type === 5 /* SDP */) {
...
var Inspector = class extends Tube {
  ...
  constructor(type) {
    ...
    const outgoing = new import_stream5.Transform({
      objectMode: true,
      transform(msg, encoding, callback) {
        outgoingLogger(msg);
        callback(void 0, msg);
...
var JPEGDepay = class extends Tube {
  constructor() {
    ...
    let packets = [];
    let jpegDepay;
    const incoming = new import_stream6.Transform({
      objectMode: true,
      transform(msg, encoding, callback) {
        if (msg.type === 5 /* SDP */) {
...
var Recorder = class _Recorder extends Tube {
  ...
  static toFile(filename = "data.json") {
    ...
    const fileStream = (0, import_fs.createWriteStream)((0, import_path.join)(cwd, filename));
...
var Replayer = class _Replayer extends Source {
  ...
  constructor(packetStream) {
    let finished = false;
    const incoming = new import_stream10.Readable({
      objectMode: true,
      read() {
      }
    });
    ...
    const outgoing = new import_stream10.Writable({
      objectMode: true,
  ...
  static fromFile(filename = "data.json") {
    const cwd = process.cwd();
    const data = (0, import_node_fs.readFileSync)((0, import_node_path.join)(cwd, filename));
...
var RtspParser = class extends Tube {
  constructor() {
    ...
    const incoming = new import_stream11.Transform({
      objectMode: true,
      transform(msg, encoding, callback) {
        if (msg.type === 1 /* RAW */) {
          try {
    ...
    const outgoing = new import_stream11.Transform({
      objectMode: true,
      transform(msg, encoding, callback) {
        if (msg.type === 4 /* RTSP */) {
...
var TcpSource = class extends Source {
  ...
  constructor(host) {
    let socket;
    const incoming = new import_stream13.Readable({
      objectMode: true,
      read() {
      }
    });
    const outgoing = new import_stream13.Writable({
      objectMode: true,
      write(msg, encoding, callback) {
        const b = msg.data;
        if (!socket) {
          ...
          socket = (0, import_node_net.connect)(
            Number(port) || 554,
...
var WSSink = class extends Sink {
  constructor(socket) {
    const outgoing = new import_stream14.Readable({
      objectMode: true,
      read: () => {
      }
    });
    const incoming = new import_stream14.Writable({
      objectMode: true,
      write: (msg, encoding, callback) => {
        try {
...
var TcpWsProxyPipeline = class extends Pipeline {
  ...
  constructor(config = {}) {
    ...
    const wss = new import_ws.WebSocketServer(wsOptions);
