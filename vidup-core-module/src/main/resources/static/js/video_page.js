...
function addVideoToPlaylist(videoId)
{
    ...
    const url = "http://localhost:8000/playlists/"+playListId+"/add/"+videoId;
...
{
    const url = "http://localhost:8000/videos/"+videoId+"/download";
...
{
    const url = "http://localhost:8000/subscriptions/unsubscribe/"+creatorId;
    var xhr = new XMLHttpRequest();
...
{
    const url = "http://localhost:8000/subscriptions/subscribe/"+creatorId;
    var xhr = new XMLHttpRequest();
...
{
    const url = "http://localhost:8000/subscriptions/subscribed_prev/"+creatorId;
    var xhr = new XMLHttpRequest();
...
function fetchPlayLists() {
    return new Promise((resolve, reject) => {
        ...
        const url = "http://localhost:8000/playlists/my";
        xhr.open('GET', url, true);
...
function reportVideo(videoId) {
    ...
    const url = "http://localhost:8000/videos/"+videoId+"/report";
    var params = "";
...
function postComment(videoId)
{
    ...
    const url = "http://localhost:8000/videos/"+videoId+"/comment";
...
function handleLike(videoId) {
    ...
    const checkUrl = "http://localhost:8000/videos/"+videoId+"/reactions/liked_prev";
    var xhr = new XMLHttpRequest();
...
function handleDislike(videoId) {
    ...
    const checkUrl = "http://localhost:8000/videos/"+videoId+"/reactions/disliked_prev";
    var xhr = new XMLHttpRequest();
    xhr.open('GET', checkUrl, true);
...
function reactOnVideo(reaction,videoId,method)
{
        ...
        const url = "http://localhost:8000/videos/"+videoId+"/reactions/react/"+reaction;
        var xhr = new XMLHttpRequest();
...
function likeVideo(videoId) {
    const likeUrl = "http://localhost:8000/videos/"+videoId+"/reactions/react/like/";
...
function updateLikeAndDislikeButtonCount(videoId) {
    ...
    const url = "http://localhost:8000/videos/"+videoId+"/reactions/count";
    var xhr = new XMLHttpRequest();
    xhr.open('GET', url, true);
